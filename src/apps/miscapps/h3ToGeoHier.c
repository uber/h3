 ...
 *
 *  See `cellToPointHier --help` for usage.
 *
...
int main(int argc, char *argv[]) {
    ...
    if (kmlArg.found) {
        ...
        char *kmlDesc = "Generated by cellToPointHier";
