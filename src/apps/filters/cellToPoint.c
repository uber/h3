 ...
 * cell center point
 *
 *  See `cellToPoint --help` for usage.
 *
 ...
 *  KML header, which default to "H3 Geometry" and "Generated by cellToPoint"
 *  respectively.
 *
 *  Examples:
 *
 *     `cellToPoint < indexes.txt`
 *        - outputs plain text cell center points for the H3 indexes contained
 *          in the file `indexes.txt`
 *
 *     `cellToPoint --kml --kml-name "kml title" --kml-description "h3 cells" <
...
int main(int argc, char *argv[]) {
    ...
    if (kmlArg.found) {
        ...
        char *kmlDesc = "Generated by cellToPoint";
