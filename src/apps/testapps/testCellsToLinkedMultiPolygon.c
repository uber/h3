...
SUITE(cellsToLinkedMultiPolygon) {
    ...
    TEST(windowsFailure) {
        ...
        t_assertSuccess(
            H3_EXPORT(cellToCenterChild)(baseCell, 1, &origin));
    ...
    //     for (int res = 1; res < 15; res++) {
    //         // Take the 1-disk of the center child at res. Note: We can't
    //         take
    //         // the 2-disk here, as increased distortion around the pentagon
    //         will
