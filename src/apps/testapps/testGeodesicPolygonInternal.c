...
SUITE(GeodesicPolygonInternal) {
    ...
    TEST(boundaryIntersection) {
        ...
        permissiveCap.center = latLngToVec3(triangleLoop.verts[0]);
        t_assert(
        ...
        farCap.center = latLngToVec3(squareLl[0]);
        t_assert(
    ...
    TEST(colinearEdgeIntersection) {
        ...
        cap.center = latLngToVec3(edgeLl[0]);
    ...
    TEST(hemispherePoleFallsBackToVertexCandidate) {
        ...
        Vec3d expectedPole = latLngToVec3(verts[1]);
    ...
    TEST(hemispherePoleFallsBackToOppositeCrossCandidate) {
        ...
        Vec3d v0 = latLngToVec3(verts[0]);
        Vec3d v1 = latLngToVec3(verts[1]);
        Vec3d expectedPole = vec3Cross(v0, v1);
    ...
    TEST(largePolygonGlobalCoverage) {
        ...
        Vec3d southVec = latLngToVec3(southPole);
    ...
    TEST(nearHemisphericPolygonGlobalCoverage) {
        ...
        Vec3d equatorVec = latLngToVec3(equatorPt);
    ...
    TEST(capRejectsAabbOutsideUnitSphere) {
        ...
        cap.center = latLngToVec3(centerLl);
