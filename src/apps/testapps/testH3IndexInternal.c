...
SUITE(h3IndexInternal) {
    TEST(faceIjkToH3ExtremeCoordinates) {
        ...
        t_assert(_faceIjkToCell(&fijk0I, 0) == 0, "i out of bounds at res 0");
        FaceIJK fijk0J = {1, {0, 4, 0}};
        t_assert(_faceIjkToCell(&fijk0J, 0) == 0, "j out of bounds at res 0");
        FaceIJK fijk0K = {2, {2, 0, 5}};
        t_assert(_faceIjkToCell(&fijk0K, 0) == 0, "k out of bounds at res 0");

        FaceIJK fijk1I = {3, {6, 0, 0}};
        t_assert(_faceIjkToCell(&fijk1I, 1) == 0, "i out of bounds at res 1");
        ...
        t_assert(_faceIjkToCell(&fijk2I, 2) == 0, "i out of bounds at res 2");
        FaceIJK fijk2J = {7, {0, 19, 1}};
        t_assert(_faceIjkToCell(&fijk2J, 2) == 0, "j out of bounds at res 2");
        FaceIJK fijk2K = {8, {2, 0, 20}};
        t_assert(_faceIjkToCell(&fijk2K, 2) == 0, "k out of bounds at res 2");
    }
}
