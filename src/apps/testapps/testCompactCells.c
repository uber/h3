...
SUITE(compact) {
    ...
    TEST(uncompact_wrongRes) {
        ...
        int sizeResult = H3_EXPORT(uncompactSize)(someHexagons, numHex, 4);
        ...
        t_assert(uncompactResult != 0,
                 "uncompact fails when given too little buffer (same "
                 "resolution)");
    ...
    TEST(someHexagon) {
        ...
        int childrenSz = H3_EXPORT(uncompactSize)(&origin, 1, 2);
    ...
    TEST(uncompact_empty) {
        int uncompactSz = H3_EXPORT(uncompactSize)(NULL, 0, 0);
    ...
    TEST(uncompact_withZero) {
        ...
        int childrenSz = H3_EXPORT(uncompactSize)(uncompactableWithZero, 4, 10);
        H3Index* children = calloc(childrenSz, sizeof(H3Index));
    ...
    TEST(pentagon) {
        ...
        int childrenSz = H3_EXPORT(uncompactSize)(&pentagon, 1, 2);
        H3Index* children = calloc(childrenSz, sizeof(H3Index));
        int uncompactResult =
