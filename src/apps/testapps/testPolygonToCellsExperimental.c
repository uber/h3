...
static GeoPolygon emptyGeoPolygonWithNullHole;
...
SUITE(polygonToCells) {
    ...
    emptyGeoPolygonWithNullHole.geoloop = emptyGeoLoop;
    emptyGeoPolygonWithNullHole.numHoles = 1;
    emptyGeoPolygonWithNullHole.holes = &nullGeoLoop;
